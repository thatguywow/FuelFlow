...
import { CreateFood, EntryActions, LogExercise, LogWeight, QuickAddSheet } from './Sheets';
...
export default function SheetHost() {
  ...
  return (
    <Suspense fallback={null}>
      ...
      {sheet.kind === 'entry-actions' && (
        <EntryActions entryId={sheet.entryId} entryName={sheet.entryName} mealId={sheet.mealId} day={sheet.day} />
      )}
